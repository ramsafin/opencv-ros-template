...
def main() -> None:
  ...
  if rospy.wait_for_message(ROS_IMAGE_TOPIC, Image, timeout=3.0) is None:
    return

  cv_bridge: CvBridge = CvBridge()
  callback = lambda msg: image_callback(msg, cv_bridge)

  rospy.Subscriber(ROS_IMAGE_TOPIC, Image, callback, queue_size=None)
